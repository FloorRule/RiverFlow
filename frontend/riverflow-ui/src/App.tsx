import { applyEdgeChanges, applyNodeChanges, Position, Handle,Background, Controls, ReactFlow, type NodeProps , type Node, type Edge, addEdge, Panel } from "@xyflow/react";
...
function APINodeInspector({
  ...
  return (
    <div className="space-y-4 bg-card text-foreground transition">
...
function Flow() {
  ...
  const [nodes, setNodes] = useState<Node<ApiNodeData>[]>(initialNodes);
      ...
      >
        <Panel position="center-right">
          <div className="w-48 max-h-[70vh] overflow-y-auto rounded-lg border border-border bg-card p-2 shadow-md">
            ...
            <NodeButton label="Condition Node" onClick={addAPINode} colorIndex={1} />
