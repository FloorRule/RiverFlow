...
export function ScriptNode({ id, data }: NodeProps<Node<ScriptNodeData>['data']>) {
  return (
    <div>
      <button
      ...
      <div className="relative flex h-20 w-20 items-center justify-center rounded-full border-2 border-yellow-500 bg-card shadow-md">
